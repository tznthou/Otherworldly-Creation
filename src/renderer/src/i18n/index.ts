...
class I18nService {
  ...
  async setLanguage(language: Language) {
    ...
    try {
      ...
      console.warn(`Failed to load translation for ${language}, keeping current language`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
    }
    ...
    try {
      ...
      if (this.currentLanguage !== 'zh-TW') {
        ...
        if (typeof fallbackValue === 'string') {
          console.warn(`Translation missing for ${key} in ${this.currentLanguage}, using zh-TW`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
          return this.interpolateParams(fallbackValue, params);
        }
      }

      // 都找不到時返回 key 本身
      console.warn(`找不到翻譯: ${key}`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
      return key;
    } catch (_error) {
      console.error(`Translation failed for key ${key}:`, _error); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
      return key;
    }
  }
  ...
  translateSync(key: string, params?: Record<string, string>): string {
    ...
    if (!currentTranslation) {
      console.warn(`Translation not loaded for ${this.currentLanguage}, returning key`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
      return key;
    }
