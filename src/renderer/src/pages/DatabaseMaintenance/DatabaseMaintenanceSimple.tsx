  ...
  return (
    <div className="h-full flex items-center justify-center bg-bg-dark">
      <div className="text-center">
        <h1 className="text-2xl font-serif-tc text-warm-gold mb-4">💾 資料管理</h1>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto">
          <div className="card text-center p-4">
            ...
            <h3 className="font-medium text-warm-gold mb-2">資料庫維護</h3>
          ...
          <div className="card text-center p-4">
            <div className="text-3xl mb-2">💿</div>
            <h3 className="font-medium text-warm-gold mb-2">備份還原</h3>
            <p className="text-sm text-gray-400 mb-3">
              管理專案資料備份檔案
            </p>
