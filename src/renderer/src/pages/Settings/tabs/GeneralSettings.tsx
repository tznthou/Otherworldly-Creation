        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between">
            <div className="flex-1 mr-4">
              ...
              <p className="text-sm text-gray-400 mb-2">
                啟用後可使用 5 個 AI 提供商：Ollama、OpenAI、Gemini、Claude、OpenRouter
              </p>
          ...
          <div className="bg-cosmic-700/30 border border-cosmic-600/50 rounded-lg p-4">
            ...
            <ul className="text-xs text-gray-400 space-y-1 ml-6">
              <li>• 智能API檢測會自動識別已配置的服務並提供品質評級</li>
              <li>• 擴展服務開啟後，插畫功能將支援所有5個AI提供商</li>
              <li>• 詳細的提供商設定請到「AI引擎」→「AI Provider管理」中配置</li>
            </ul>
          </div>
        </div>
      </div>
