...
export function useBatchExportProcessor(
  ...
  const addImageToExport = useCallback((imageId: string, imageUrl: string, fileName?: string) => {
    ...
    console.log(`📥 [BatchExportProcessor] 添加圖片到導出佇列: ${imageId}`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
  }, [exportManager]);
  ...
  const addMultipleImages = useCallback((images: Array<{ id: string; url: string; fileName?: string }>) => {
    ...
    console.log(`📥 [BatchExportProcessor] 批次添加 ${images.length} 張圖片到導出佇列`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
  }, [exportManager]);
  ...
  const processCurrentQueue = useCallback(async () => {
    ...
    try {
      ...
      console.log(`🚀 [BatchExportProcessor] 開始處理 ${pendingTasks.length} 個任務`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
      ...
      console.log(`✅ [BatchExportProcessor] 批次處理完成: ${completedCount} 成功, ${failedCount} 失敗`); // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換 // TODO: 複雜模式，需人工轉換
