...
const BackupManagerModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-bg-dark border border-warm-gold/10 rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        {/* 標題 */}
        <div className="p-6 border-b border-warm-gold/10 flex items-center justify-between">
          <h2 className="text-xl font-serif-tc text-warm-gold">💿 備份還原管理</h2>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-serif-tc text-warm-gold mb-4">備份還原功能</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto">
              <div className="card text-center p-4">
                ...
                <h4 className="font-medium text-warm-gold mb-2">建立備份</h4>
              ...
              <div className="card text-center p-4">
                <div className="text-3xl mb-2">📂</div>
                <h4 className="font-medium text-warm-gold mb-2">還原備份</h4>
                <p className="text-sm text-gray-400 mb-3">
                  從備份檔案還原專案
                </p>
                <button 
