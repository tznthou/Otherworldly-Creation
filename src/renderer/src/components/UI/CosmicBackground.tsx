  ...
  return (
    <div className={`fixed inset-0 pointer-events-none overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-warm-gold/50/5 rounded-full blur-3xl animate-pulse" />
        ...
        <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-bg-light/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
    </div>
  );
};
