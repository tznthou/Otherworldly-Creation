    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="relative">
        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          <svg className="h-5 w-5 text-text-secondary/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <input
          ...
          className="block w-full pl-10 pr-3 py-2 bg-bg-dark/80 border border-warm-gold/10 text-text-secondary/20 placeholder-cosmic-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="block w-full px-3 py-2 bg-bg-dark/80 border border-warm-gold/10 text-text-secondary/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent"
          >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <select
            ...
            className="px-3 py-2 bg-bg-dark/80 border border-warm-gold/10 text-text-secondary/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent"
          >
